...
match_data_A <- read.csv(file = paste0("/home/pwlodzimierz/Rhynchospora/upload_data/09.021_out_data/", flanking_range, "_", 
                                       flanging_skip, "_", genome_A, "_", genome_B, ".csv"))
match_data_B <- read.csv(file = paste0("/home/pwlodzimierz/Rhynchospora/upload_data/09.021_out_data/", flanking_range, "_", 
                                       flanging_skip, "_", genome_B, "_", genome_A, ".csv"))
